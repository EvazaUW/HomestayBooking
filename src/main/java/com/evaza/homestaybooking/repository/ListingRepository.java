package com.evaza.homestaybooking.repository;
...
public interface ListingRepository extends JpaRepository<ListingEntity, Long> {
    ...
    @Query(value = """
           ...
           """, nativeQuery = true)
    List<ListingEntity> searchListings(double lat, double lon, double distance, LocalDate checkIn, LocalDate checkOut,
                                       int guestNum);
}
